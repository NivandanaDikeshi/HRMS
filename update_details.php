...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Update Details</a> </div>
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td class="center">
				  <div class="btn-group">
				  <button data-toggle="dropdown" class="btn btn-success dropdown-toggle">Update Details<span class="caret"></span></button>
				  <ul class="dropdown-menu">
					...
					<li><a href="loan_details.php?pid=<?php echo $row['personal_info_id']; ?>">Promotion Details</a></li>
				  </ul>
				</div>
				  </td>
                </tr>                                                         
