...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <div class="row-fluid">
      ...
      <div class="control-group">
        <label class="control-label">Marternity Leave Type :</label>
        <div class="controls">
          <select class="span8" name="Maternity_leave_type">
				<option value="0" selected>Select Maternity Leave Type</option>
				<option value="Local">Full Pay</option>
				<option value="Annual">Half Pay</option>
        <option value="Annual">With out Pay</option>
          </select>
        </div>
      </div>
